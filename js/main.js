...
$(function () {
  ...
  let i = 0;
  let txt = 'Hello I am Marcos Quiroga Frontend Developer';
  let speed = 80;
  let t = '';
  function typeWrite() {
    if (i < txt.length) {
  ...
  $form.children[3].children[0].children[0].innerHTML += 'Enviar Mensaje';
  console.log($form.children[3].children[0].children[0].children[0]);
  $form.addEventListener('submit', (e) => {
    e.preventDefault();
    $form.children[3].children[0].children[0].childNodes[2].remove();
    $form.children[3].children[0].children[0].children[0].classList.remove(
      'none'
    );

    fetch('https://formsubmit.co/ajax/671620cf3ad33e777fe862638b4f8ec5', {
      method: 'POST',
      ...
      .then((json) => {
        ...
        $form.children[3].children[0].children[0].children[0].classList.add(
          'none'
        );
        $form.children[3].children[0].children[0].innerHTML += 'Enviar Mensaje';
        $form.reset();
        $form.children[0].children[0].classList.remove('art-active');
        $form.children[1].children[0].classList.remove('art-active');
        $form.children[2].children[0].classList.remove('art-active');
        $form.children[3].children[0].classList.remove('art-active');
      })
      .catch();
  });
});
